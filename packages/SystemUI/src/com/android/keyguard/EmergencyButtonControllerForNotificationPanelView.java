...
public class EmergencyButtonControllerForNotificationPanelView extends ViewController<EmergencyButton> {
    ...
    private EmergencyButtonControllerForNotificationPanelView(@Nullable EmergencyButton view,
    ...
    public static class Factory {
        ...
        public EmergencyButtonControllerForNotificationPanelView create(EmergencyButton view) {
            return new EmergencyButtonControllerForNotificationPanelView(view, mConfigurationController,
