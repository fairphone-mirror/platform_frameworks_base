...
public class PowerNotificationWarnings implements PowerUI.WarningsUI {
    ...
    public void showHighTemp(boolean charging) {
        ...
        if (charging) {
            message = mContext.getResources().getString(R.string.high_temp_message);
        } else {
            message = mContext.getResources().getString(R.string.high_temp_message_notchanging);
        }
        mHighTemp = new AlertDialog.Builder(mContext)
                .setTitle(mContext.getResources().getString(R.string.high_temp_title_custom))
                .setMessage(message)
