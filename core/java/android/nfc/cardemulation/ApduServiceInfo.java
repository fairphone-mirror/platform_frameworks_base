...
public class ApduServiceInfo implements Parcelable {
     ...
     */
    @UnsupportedAppUsage
    protected final HashMap<String, AidGroup> mStaticAidGroups;

    /**
     * Mapping from category to dynamic AID group
     */
    @UnsupportedAppUsage
    protected final HashMap<String, AidGroup> mDynamicAidGroups;

    /**
     * Whether this service should only be started when the device is unlocked.
     */
    protected final boolean mRequiresDeviceUnlock;
     ...
     */
    protected final int mBannerResourceId;
     ...
     */
    protected final String mSettingsActivityName;
